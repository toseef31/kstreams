          ...
          xhrFields: {withCredentials: true}
           ...
           // $scope.reveiveGroupCall  = false;
            ...
            .then(function(response) {
                ...
                console.log('1- $scope.allUsers ',$scope.allUsers);
    		...
    		$scope.sendMessage = function(sendType,message = 0,chkmsg=0){
                ...
                if( sendType == 'chat' ){
                    ...
                    if( $scope.edit === true ){
                        ...
                        $http.post('/chat',{"senderId":$scope.user._id,"senderImage":$scope.user.user_image,"receiverImage":$scope.chatWithImage,"recevierId":$scope.chatWithId,"senderName":$scope.user.name,"message":$scope.message})
                        .then(function(res){ 
