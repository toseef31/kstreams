      ...
      function captureUserMedia(callback, extensionAvailable) {
          ...
          getScreenId(function(error, sourceId, screen_constraints) {
              ...
              navigator.mediaDevices.getUserMedia(screen_constraints).then(function(stream) {
                  ...
                  video.muted = true;
                  video.volume = 0;
                  video.className = 'screenshareHeight';

                  try {
                    //   video.setAttributeNode(document.createAttribute("style='height: 54%'"));
                      video.setAttributeNode(document.createAttribute('autoplay'));
                      video.setAttributeNode(document.createAttribute('playsinline'));
                      video.setAttributeNode(document.createAttribute('controls'));
                  } catch (e) {
  ...
  function Signaler(root, roomid) {
      ...
      this.join = function(_config) {
        console.log('join');
          ...
          //this.onmessage(_config); //? --------- TESTING LINE -----------------
      };
